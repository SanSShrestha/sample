...
class _ProductpageState extends State<Productpage> {
  List<Product> products = [
    ...
    Product(
      ...
      price: "3200",
      brand: "Vans",
      image: "https://mixmag.asia/assets/uploads/images/_facebook/SCR-VANS.jpg",
      description:
          "What is Lorem Ipsum Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industry's standard dummy text ever since the 1500s when an unknown printer took a galley of type and scrambled it to make a type specimen book it has?",
    ),
  ];
            ...
            SizedBox(
              ...
              child: ListTile(
                trailing: Image.network(
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Logomarca_da_VANS.png/220px-Logomarca_da_VANS.png"),
                title: Text("Vans off the Walls",
