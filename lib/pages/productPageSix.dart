...
class ProductPageSix extends StatefulWidget {
  @override
  _ProductPageSixState createState() => _ProductPageSixState();
}

class _ProductPageSixState extends State<ProductPageSix> {
  List<Product> products = [
    Product(
        ...
        brand: "Vans",
        image:
            "https://images.pexels.com/photos/4088811/pexels-photo-4088811.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"),
    Product(
        sku: "v002",
        name: "Old skool",
        price: "3200",
            ...
            SizedBox(
              ...
              child: ListTile(
                trailing: Image.network(
                  "https://stardollrev0lution.files.wordpress.com/2018/07/balenciaga13.png",
                ),
